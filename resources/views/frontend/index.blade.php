...
<head>
  ...
  <meta name="google-site-verification" content="M_rFth3LyEF1_DvKiZHgOTuMz1-bc9Xygy_lEQFMTy0" />


  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-HKC3WVXGQD"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-HKC3WVXGQD');
</script>
...
<!-- carousel -->
<div id="carouselExampleCaptions" class="carousel slide main-carousel" data-bs-ride="carousel">
      ...
      <div class="about--inner">
        <div class="row">
          <div class="col-md-6 col-12">
            <img src="assets/img/about-img.png" class="about--sm-img img-fluid" alt="">
          </div>
          <div class="col-md-6 col-12">
            <h3  class="main-head mt-3 mt-md-0">About Us</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde fuga asperiores illum. Molestias quas esse officia, incidunt tempore nobis dignissimos, debitis aut repellendus dicta minus rerum illum quibusdam reiciendis placeat!
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde fuga asperiores illum. Molestias quas esse officia, incidunt tempore nobis dignissimos, debitis aut repellendus dicta minus rerum illum quibusdam reiciendis placeat!</p>
            <div class="mt-3 about--btns">
              <a href="#" class="button about-btn">Read More</a>
              <a href="#" class="call-sm-box"><i class="fa-solid fa-phone"></i>+971 67417950</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="popular-product-section">
    <div class="container">
      <h3  class="main-head text-center"><span class="green">Popular </span><span class="blue">Products</span></h3>
  ...
  <div class="factories-section">
    <div class="mb-4">
      ...
      <p class="text-center">Our Branches are located at Ajman, Abu Dhabi, & Ras AL Khaimah</p>
    </div>
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-7">
              <div class="quote_content">
                  ...
                  <form action="{{ url('account/add-subscription') }}" method="POST"  enctype="multipart/form-data" class="row px-md-0 px-4">
                        ...
                        <button class="input__btn col-md-2 col-12" type="submit">Submit</button>
                  </form>
              </div>
          </div>
